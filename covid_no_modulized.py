...
state_count = pd.read_csv("../plotly_dash/state_case.csv")
...
state_mandate = pd.read_csv("../plotly_dash/state_mandates.csv")
...
def update_lineplot_graph(click, n_clicks, input1, input2):
    ...
    count.sort()
    for date, mandate in zip(state_mandate_cp_1['date'], state_mandate_cp_1['policy_type']):
    ...
    count.sort()
    for date, mandate in zip(state_mandate_cp_2['date'], state_mandate_cp_2['policy_type']):
